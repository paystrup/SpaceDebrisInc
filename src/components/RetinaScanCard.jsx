...
export default function RetinaScanCard({
  content,
  packageName,
  number,
  paragraph,
  ...
  return (
    <div
      ...
      className="prevent-select packagedisplaycard bg-primaryGray-900 h-96 w-full px-5 py-5 flex flex-col justify-between border-dashed border-2 border-primaryGray-300"
    >
